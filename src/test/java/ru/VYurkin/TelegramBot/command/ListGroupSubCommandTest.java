...
import static ru.VYurkin.TelegramBot.command.CommandName.LIST_GROUP_SUB;
...
public class ListGroupSubCommandTest {
    ...
    public void shouldProperlyShowsListGroupSub() {
        ...
        Mockito.when(message.getChatId()).thenReturn(Long.valueOf(telegramUser.getChartId()));
